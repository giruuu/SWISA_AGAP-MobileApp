...
class GrantStatusDetails extends StatefulWidget {
  @override
  _GrantStatusDetailsState createState() => _GrantStatusDetailsState();
}

class _GrantStatusDetailsState extends State<GrantStatusDetails> {
  @override
                  ...
                  Expanded(
                    child: Column(
                      ...
                      children: [
                        ...
                        _buildDetailRow('STATUS: ', 'VERIFYING DOCUMENTS'),
                      ],
                    ),
                  ),
    ...
    return ElevatedButton(
      onPressed: () {
        Navigator.of(context).push(
          MaterialPageRoute(builder: (context) => const ViewDetailsScreen()),
        );
      },
